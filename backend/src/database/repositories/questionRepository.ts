...
/**
 * Handles database operations for the Question.
...
class QuestionRepository {
  ...
  static async update(id, data, options) {
    ...
    let record = await options.database.question.findByPk(
      id,
      {
        transaction,
      },
  ...
  static async findById(id, options) {
    ...
    const record = await options.database.question.findByPk(
      id,
      {
        include,
        transaction,
  ...
  /**
   * Fills an array of Question with relations and files.
   *
   * @param {Array} rows
   * @param {Object} [options]
   */
  ...
  /**
   * Fill the Question with the relations and files.
   *
   * @param {Object} record
   * @param {Object} [options]
   */
