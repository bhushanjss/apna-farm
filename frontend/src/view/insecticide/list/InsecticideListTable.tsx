...
import InsectListItem from 'src/view/insect/list/InsectListItem';

function InsecticideListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    insecticideSelectors.selectPermissionToEdit,
  );
          ...
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                ...
                name={'name'}
                label={i18n(
                  'entities.insecticide.fields.name',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'type'}
                label={i18n(
                  'entities.insecticide.fields.type',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'description'}
                label={i18n(
                  'entities.insecticide.fields.description',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'materials'}
                label={i18n(
                  'entities.insecticide.fields.materials',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.insecticide.fields.insects',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'cost'}
                label={i18n(
                  'entities.insecticide.fields.cost',
                )}
                align="right"
              />              
          ...
          <TableBody>
            ...
            {!loading &&
              rows.map((row) => (
                ...
                <TableCell>
                  <InsectListItem value={row.insects} />
                </TableCell>
...
export default InsecticideListTable;
