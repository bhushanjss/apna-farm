...
import AgentListItem from 'src/view/agent/list/AgentListItem';
import LandListItem from 'src/view/land/list/LandListItem';

function FarmerListTable(props) {
  const [
    recordIdToDestroy,
        ...
        >
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                label={i18n(
                  'entities.farmer.fields.person',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.farmer.fields.agent',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'area'}
                label={i18n(
                  'entities.farmer.fields.area',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.farmer.fields.lands',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
          ...
          <TableBody>
            ...
            {!loading &&
              rows.map((row) => (
                ...
                <TableCell>
                  <AgentListItem value={row.agent} />
                </TableCell>
                <TableCell>{row.area}</TableCell>
                <TableCell>
                  <LandListItem value={row.lands} />
                </TableCell>
