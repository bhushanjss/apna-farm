          ...
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                ...
                name={'description'}
                label={i18n(
                  'entities.disease.fields.description',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.disease.fields.crops',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.disease.fields.plants',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'remedy'}
                label={i18n(
                  'entities.disease.fields.remedy',
                )}
              />              
