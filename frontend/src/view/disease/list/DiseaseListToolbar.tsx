...
function DiseaseToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    diseaseSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    diseaseSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=disease"
