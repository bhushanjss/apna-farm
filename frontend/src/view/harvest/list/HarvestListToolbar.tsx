...
function HarvestToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    harvestSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    harvestSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=harvest"
