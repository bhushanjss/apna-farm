...
import actions from 'src/modules/agent/importer/agentImporterActions';
...
function AgentImportPage() {
  const Importer = importerHoc(
    selectors,
    actions,
    fields,
    i18n('entities.agent.importer.hint'),
  );
    ...
    <>
      <Breadcrumb
        items={[
          ...
          [i18n('entities.agent.importer.title')],
        ]}
      />
