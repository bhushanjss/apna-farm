...
function AnswerToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    answerSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    answerSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=answer"
