...
import exporterFields from 'src/modules/farmingMethod/list/farmingMethodListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'FARMINGMETHOD_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await FarmingMethodService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.farmingMethod.exporterFileName'),
