import listActions from 'src/modules/farmingMethod/list/farmingMethodListActions';
...
const prefix = 'FARMINGMETHOD_DESTROY';
...
const actions = {
  ...
  doDestroy: (id) => async (dispatch) => {
    try {
      ...
      await FarmingMethodService.destroyAll([id]);
      ...
      Message.success(
        i18n('entities.farmingMethod.destroy.success'),
      );
  ...
  doDestroyAll: (ids) => async (dispatch) => {
    try {
      ...
      await FarmingMethodService.destroyAll(ids);
      ...
      Message.success(
        i18n('entities.farmingMethod.destroyAll.success'),
      );
