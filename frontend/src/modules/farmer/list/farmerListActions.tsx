...
import exporterFields from 'src/modules/farmer/list/farmerListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'FARMER_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await FarmerService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.farmer.exporterFileName'),
