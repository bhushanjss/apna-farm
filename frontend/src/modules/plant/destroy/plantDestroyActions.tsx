import listActions from 'src/modules/plant/list/plantListActions';
...
const actions = {
  ...
  doDestroy: (id) => async (dispatch) => {
    try {
      ...
      await PlantService.destroyAll([id]);
      ...
      Message.success(
        i18n('entities.plant.destroy.success'),
      );
  ...
  doDestroyAll: (ids) => async (dispatch) => {
    try {
      ...
      await PlantService.destroyAll(ids);
      ...
      Message.success(
        i18n('entities.plant.destroyAll.success'),
      );
