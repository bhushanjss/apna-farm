...
import exporterFields from 'src/modules/soil/list/soilListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'SOIL_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await SoilService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.soil.exporterFileName'),
