...
import exporterFields from 'src/modules/pest/list/pestListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'PEST_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await PestService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.pest.exporterFileName'),
