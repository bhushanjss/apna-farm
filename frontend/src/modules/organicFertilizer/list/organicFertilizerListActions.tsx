...
import exporterFields from 'src/modules/organicFertilizer/list/organicFertilizerListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'ORGANICFERTILIZER_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await OrganicFertilizerService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.organicFertilizer.exporterFileName'),
