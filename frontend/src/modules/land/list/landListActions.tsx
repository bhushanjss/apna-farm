...
import exporterFields from 'src/modules/land/list/landListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'LAND_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await LandService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.land.exporterFileName'),
