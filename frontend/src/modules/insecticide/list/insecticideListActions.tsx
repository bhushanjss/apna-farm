...
import exporterFields from 'src/modules/insecticide/list/insecticideListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'INSECTICIDE_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await InsecticideService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.insecticide.exporterFileName'),
