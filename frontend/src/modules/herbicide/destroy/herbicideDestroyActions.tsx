import listActions from 'src/modules/herbicide/list/herbicideListActions';
...
const prefix = 'HERBICIDE_DESTROY';
...
const actions = {
  ...
  doDestroy: (id) => async (dispatch) => {
    try {
      ...
      await HerbicideService.destroyAll([id]);
      ...
      Message.success(
        i18n('entities.herbicide.destroy.success'),
      );
  ...
  doDestroyAll: (ids) => async (dispatch) => {
    try {
      ...
      await HerbicideService.destroyAll(ids);
      ...
      Message.success(
        i18n('entities.herbicide.destroyAll.success'),
      );
