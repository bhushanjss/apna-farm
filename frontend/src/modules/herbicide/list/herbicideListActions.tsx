...
import exporterFields from 'src/modules/herbicide/list/herbicideListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'HERBICIDE_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await HerbicideService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.herbicide.exporterFileName'),
