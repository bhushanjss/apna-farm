...
import exporterFields from 'src/modules/weed/list/weedListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'WEED_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await WeedService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.weed.exporterFileName'),
