import listActions from 'src/modules/weed/list/weedListActions';
...
const actions = {
  ...
  doDestroy: (id) => async (dispatch) => {
    try {
      ...
      await WeedService.destroyAll([id]);
      ...
      Message.success(
        i18n('entities.weed.destroy.success'),
      );
  ...
  doDestroyAll: (ids) => async (dispatch) => {
    try {
      ...
      await WeedService.destroyAll(ids);
      ...
      Message.success(
        i18n('entities.weed.destroyAll.success'),
      );
