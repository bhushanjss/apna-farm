...
import exporterFields from 'src/modules/pesticide/list/pesticideListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'PESTICIDE_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await PesticideService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.pesticide.exporterFileName'),
