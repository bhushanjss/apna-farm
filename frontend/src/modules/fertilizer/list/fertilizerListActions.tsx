...
import exporterFields from 'src/modules/fertilizer/list/fertilizerListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'FERTILIZER_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await FertilizerService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.fertilizer.exporterFileName'),
