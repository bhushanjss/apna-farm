...
import exporterFields from 'src/modules/irrigation/list/irrigationListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'IRRIGATION_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await IrrigationService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.irrigation.exporterFileName'),
