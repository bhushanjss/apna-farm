...
import exporterFields from 'src/modules/cropVariety/list/cropVarietyListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'CROPVARIETY_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await CropVarietyService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.cropVariety.exporterFileName'),
