import listActions from 'src/modules/insect/list/insectListActions';
...
const actions = {
  ...
  doDestroy: (id) => async (dispatch) => {
    try {
      ...
      await InsectService.destroyAll([id]);
      ...
      Message.success(
        i18n('entities.insect.destroy.success'),
      );
  ...
  doDestroyAll: (ids) => async (dispatch) => {
    try {
      ...
      await InsectService.destroyAll(ids);
      ...
      Message.success(
        i18n('entities.insect.destroyAll.success'),
      );
