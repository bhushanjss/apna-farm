...
import exporterFields from 'src/modules/insect/list/insectListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'INSECT_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await InsectService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.insect.exporterFileName'),
