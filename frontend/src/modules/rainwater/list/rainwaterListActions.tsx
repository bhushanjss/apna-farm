...
import exporterFields from 'src/modules/rainwater/list/rainwaterListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'RAINWATER_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await RainwaterService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.rainwater.exporterFileName'),
