...
import exporterFields from 'src/modules/answer/list/answerListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'ANSWER_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await AnswerService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.answer.exporterFileName'),
