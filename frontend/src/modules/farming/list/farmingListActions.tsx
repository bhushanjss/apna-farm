...
import exporterFields from 'src/modules/farming/list/farmingListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'FARMING_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await FarmingService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.farming.exporterFileName'),
