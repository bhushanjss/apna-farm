import listActions from 'src/modules/plantVariety/list/plantVarietyListActions';
...
const prefix = 'PLANTVARIETY_DESTROY';
...
const actions = {
  ...
  doDestroy: (id) => async (dispatch) => {
    try {
      ...
      await PlantVarietyService.destroyAll([id]);
      ...
      Message.success(
        i18n('entities.plantVariety.destroy.success'),
      );
  ...
  doDestroyAll: (ids) => async (dispatch) => {
    try {
      ...
      await PlantVarietyService.destroyAll(ids);
      ...
      Message.success(
        i18n('entities.plantVariety.destroyAll.success'),
      );
