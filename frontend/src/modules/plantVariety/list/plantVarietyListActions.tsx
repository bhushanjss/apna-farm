...
import exporterFields from 'src/modules/plantVariety/list/plantVarietyListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'PLANTVARIETY_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await PlantVarietyService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.plantVariety.exporterFileName'),
