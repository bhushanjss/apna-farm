...
import exporterFields from 'src/modules/disease/list/diseaseListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'DISEASE_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await DiseaseService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.disease.exporterFileName'),
