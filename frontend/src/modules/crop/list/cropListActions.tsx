...
import exporterFields from 'src/modules/crop/list/cropListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'CROP_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await CropService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.crop.exporterFileName'),
