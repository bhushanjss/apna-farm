...
import exporterFields from 'src/modules/harvest/list/harvestListExporterFields';
import Errors from 'src/modules/shared/error/errors';
import Exporter from 'src/modules/shared/exporter/exporter';

const prefix = 'HARVEST_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await HarvestService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.harvest.exporterFileName'),
